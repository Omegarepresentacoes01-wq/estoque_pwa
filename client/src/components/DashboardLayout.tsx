...
import { BarChart3, Calendar, LogOut, PanelLeft, Truck, Upload } from "lucide-react";
...
const menuItems = [
  ...
  { icon: Truck, label: "Estoque Geral", path: "/estoque" },
                ...
                return (
                  <SidebarMenuItem key={item.path}>
                    <SidebarMenuButton
                      ...
                      tooltip={item.label}
                      className={`h-9 transition-all font-normal rounded-lg ${isActive ? 'bg-primary/10 text-primary' : 'hover:bg-accent/50'}`}
                    >
          ...
          <SidebarFooter className="p-3 border-t border-border/30">
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <button className="flex items-center gap-3 rounded-lg px-2 py-2 hover:bg-accent/50 transition-colors w-full text-left focus:outline-none group-data-[collapsible=icon]:justify-center">
